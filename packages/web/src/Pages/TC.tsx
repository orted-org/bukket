function TermsAndConditions() {
  document.title = "Terms and Conditions | Bukket";
  return (
    <div style={{ padding: "50px" }}>
      <h2>
        <strong>Terms and Conditions</strong>
      </h2>
      <p>Welcome to Bukket!</p>
      <p>
        These terms and conditions outline the rules and regulations for the use
        of bukket.cloud's Website, located at bukket.cloud.
      </p>
      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Bukket if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing Bukket, you agreed to use
        cookies in agreement with the bukket.cloud's Privacy Policy.{" "}
      </p>
      <p>
      ...
      <p>
        Unless otherwise stated, bukket.cloud and/or its licensors own the
        intellectual property rights for all material on Bukket. All
        intellectual property rights are reserved. You may access this from
        Bukket for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>
      <p>You must not:</p>
      <ul>
        <li>Republish material from Bukket</li>
        <li>Sell, rent or sub-license material from Bukket</li>
        <li>Reproduce, duplicate or copy material from Bukket</li>
        <li>Redistribute content from Bukket</li>
      </ul>
      <p>This Agreement shall begin on the date hereof.</p>
      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        bukket.cloud does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of bukket.cloud,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, bukket.cloud shall not be
      ...
      <p>
        bukket.cloud reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant bukket.cloud a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of bukket.cloud; and (d) the link
      ...
      <p>
        ...
        e-mail to bukket.cloud. Please include your name, your organization
      ...
      <p>
        No use of bukket.cloud's logo or other artwork will be allowed for
