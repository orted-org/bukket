function PrivacyPolicy() {
  document.title = "Privacy Policy | Bukket";
  return (
    <div style={{ padding: "50px" }}>
      <h1>Privacy Policy for bukket.cloud</h1>
      <p>
        At Bukket, accessible from bukket.cloud, one of our main priorities is
        the privacy of our visitors. This Privacy Policy document contains types
        of information that is collected and recorded by Bukket and how we use
        it.
      </p>
      <p>
      ...
      <p>
        ...
        shared and/or collect in Bukket. This policy is not applicable to any
      ...
      <h2>Log Files</h2>
      <p>
        Bukket follows a standard procedure of using log files. These files log
      ...
      <p>
        Like any other website, Bukket uses 'cookies'. These cookies are used to
      ...
      <p>
        ...
        advertising partners of Bukket.
      </p>
      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Bukket, which are sent directly
      ...
      <p>
        Note that Bukket has no access to or control over these cookies that are
        used by third-party advertisers.
      </p>
      <h2>Third Party Privacy Policies</h2>
      <p>
        Bukket's Privacy Policy does not apply to other advertisers or websites.
      ...
      <p>
        Bukket does not knowingly collect any Personal Identifiable Information
